...
$url = 'http://'.$_SERVER['SERVER_NAME'].'/mosha/reissue/input_pass.php?urltoken='.$_SESSION['urltoken'];

$mailTo = $_SESSION['mail'];
$returnMail = 'minimono1001@yahoo.co.jp';
$name = 'ミニモノ';
$mail = 'minimono1001@yahoo.co.jp';
$subject = '【MOSHA】パスワード再設定用URLのお知らせ';
$body = <<< EOM
24時間以内に下記のURLからパスワードを再設定してください。
{$url}
...
if(mb_send_mail($mailTo, $subject, $body, $header, '-f'.$returnMail)){
  $message = 'メールをお送りしました。<br>24時間以内にメールに記載されたURLからパスワードを再設定してください。';
}else{
